...
function categories_jalan_1(feature, value, size, resolution, labelText,
                ...
                switch(valueStr) {case 'Jalan Arte':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(247,128,30,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.268}),
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(151,234,128,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
