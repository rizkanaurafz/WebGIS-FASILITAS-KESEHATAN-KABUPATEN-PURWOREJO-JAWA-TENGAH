...
map.getView().fit([12212718.267709, -883085.791437, 12275757.964984, -833674.497442], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Fasilitas Kesehatan Kabupaten Purworejo</h2>';
        return titleElement;
    })(),
